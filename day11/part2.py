...
Part 2: Now we need to compute the distances but instead of expanding the galaxy, we have to sum up in a smart way the distances between the galaxies.
Or maybe we can expand the galaxies and then compute the distances - this bruteforce worked.
"""
...
def expand_galaxies(galaxies, empty_rows, empty_cols):
    ...
    for galaxy in galaxies:
        ...
        for empty_row in empty_rows:
            if row >= empty_row:
                row_increment += 999999
        for empty_col in empty_cols:
            if col >= empty_col:
                col_increment += 999999
...
def test_expansion():
    ...
    expected_galaxies = [(0, 1000002), (1, 2000005), (2, 0), (1000003, 2000004), (1000004, 1), (1000005, 3000006), (2000006, 2000005), (2000007, 0), (2000007, 1000003)]
